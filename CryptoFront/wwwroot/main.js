...
/* harmony import */ var _services_crypto_crypto_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./services/crypto/crypto.service */ "./src/app/services/crypto/crypto.service.ts");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                _services_crypto_crypto_service__WEBPACK_IMPORTED_MODULE_11__["CryptoService"],
...
/* harmony import */ var _services_crypto_crypto_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../services/crypto/crypto.service */ "./src/app/services/crypto/crypto.service.ts");
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.authService.logIn(encName, encPassword, Object(moment__WEBPACK_IMPORTED_MODULE_3__["duration"])("00:05:00")).subscribe(function (result) { }, function (error) { });
    };
    ...
    LoginComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_crypto_crypto_service__WEBPACK_IMPORTED_MODULE_2__["CryptoService"],
...
var AuthService = /** @class */ (function (_super) {
    ...
    AuthService.prototype.signIn = function (name, password, location, sessionLifetime) {
    ...
    AuthService.prototype.logOut = function (token) {
        return this.http.post(this.baseUrl + "/login", {}, this.getOptions());
    };
...
var CategoryService = /** @class */ (function (_super) {
    ...
    CategoryService.prototype.getChildren = function (parentId) {
        return this.http.get(this.baseUrl + "/" + parentId, this.getOptions());
    };
    CategoryService.prototype.createParent = function (name) {
        return this.http.post("" + this.baseUrl, name, this.getOptions());
    };
    CategoryService.prototype.createChild = function (parentId, name) {
        return this.http.post(this.baseUrl + "/" + parentId, name, this.getOptions());
    };
...
var CommentService = /** @class */ (function (_super) {
    ...
    CommentService.prototype.getForArticle = function (articleId, index, count) {
        return this.http.get(this.baseUrl + "/article/" + articleId + "/" + index + "/" + count, this.getOptions());
    };
    CommentService.prototype.getForComment = function (parentId, index, count) {
        return this.http.get(this.baseUrl + "/comment/" + parentId + "/" + index + "/" + count, this.getOptions());
    };
    CommentService.prototype.getAllVersions = function (id) {
        return this.http.get(this.baseUrl + "/" + id + "/versions", this.getOptions());
    };
    CommentService.prototype.createForArticle = function (articleId, text) {
        return this.http.post(this.baseUrl + "/article/" + articleId, text, this.getOptions());
    };
    CommentService.prototype.createForComment = function (parentId, text) {
        return this.http.post(this.baseUrl + "/comment/" + parentId, text, this.getOptions());
    };
    CommentService.prototype.edit = function (id, text) {
        return this.http.put(this.baseUrl + "/" + id, text, this.getOptions());
    };
...
var CryptoService = /** @class */ (function () {
    ...
    CryptoService.prototype.encrypt = function (data, key) {
        return crypto_js__WEBPACK_IMPORTED_MODULE_1__["AES"].encrypt(data, key).toString();
    };
    CryptoService.prototype.decrypt = function (data, key) {
        return crypto_js__WEBPACK_IMPORTED_MODULE_1__["AES"].decrypt(data, key).toString(crypto_js__WEBPACK_IMPORTED_MODULE_1__["enc"].Utf8);
    };
